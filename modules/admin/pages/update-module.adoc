...
* *Если комплект обновления включает обновление для модуля "{pl}"*, перейдите к инструкции, приведенной xref:new-admin-console@platform:admin:update-module.adoc[в документации] модуля {pl}.
