...
Без установки и первоначальной настройки {of-mc} не будет функционировать базовый модуль "xref:CU5@workerservice::index.adoc[Служба {ws}]", необходимый для создания групп заданий и отправки почтовых уведомлений.
...
include::CU5@platform:admin:partial$install.adoc[]
+
[source,json]
----
{
...
Установка Сервиса внешнего API не требуется в самой новой версии {of-mc}.
...
----
+
include::CU5@install-linux:ROOT:partial$restart-and-db.adoc[]
...
См. подробнее в руководстве пользователя Консоли управления "xref:CU5@mgmtconsole:user:initial-configuration.adoc[]".
...
include::CU5@platform:admin:config-domains.adoc[tags=chalto]
...
:wt: managementconsole
include::CU5@platform:admin:partial$delete.adoc[]
