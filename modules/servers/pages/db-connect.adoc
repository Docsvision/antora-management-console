...
image::dev@mgmtconsole:servers:db-connect-start.png[Мастер БД {dv} в режиме подключения базы данных]
+
--
...
+
.Параметры БД
image::dev@mgmtconsole:servers:db-connect-name.png[Параметры БД]
+
****
include::dev@mgmtconsole:servers:partial$excerpts.adoc[tags=dbname-1]

include::dev@mgmtconsole:servers:partial$excerpts.adoc[tags=dbalias-1]
****
+
...
image::dev@mgmtconsole:servers:db-connect-launch.png[Запуск обновления подключаемой БД]
+
[WARNING]
====
