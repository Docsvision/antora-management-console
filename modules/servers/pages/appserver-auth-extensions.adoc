...
// tag::setup[]
. Откройте {mc} на странице "xref:dev@mgmtconsole:servers:appserver-auth-extensions.adoc[]" нажмите кнопку *Добавить расширение*.
+
...
ifndef::ald[]
* Название расширения -- задаёт отображаемое имя сервиса аутентификации в xref:new-admin-console@webclient:user:directories/staff/employee-fields.adoc#security[справочнике сотрудников].
endif::ald[]
+
.Регистрация нового расширения аутентификации
image::dev@mgmtconsole:servers:new-auth-extension.png[Регистрация нового расширения аутентификации]
// end::setup[]
+
